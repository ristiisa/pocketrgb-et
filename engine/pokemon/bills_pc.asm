...
SomeonesPCText:   db "VÕÕRAS ARVUTI@"
BillsPCText:      db "MASAKI ARVUTI@"
PlayersPCText:    db " PC@"
OaksPCText:       db "DR.OHKIDO PC@"
PKMNLeaguePCText: db "<PKMN>LIIGA@"
LogOffPCText:     db "VÄLJU@"
...
DepositPCText:  db "PANE@"
WithdrawPCText: db "VÕTA@"
StatsCancelPCText:
	db   "OLEK"
	next "TAGASI@"
