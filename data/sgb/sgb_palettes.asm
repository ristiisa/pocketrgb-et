...
IF DEF(_GREEN)
	...
	RGB 31,29,31, 30,30,17, 21,00,04, 08,31,00 ; PAL_LOGO2
ENDC
...
ENDC
IF DEF(_GREEN)
	RGB 31,29,31, 31,31,17, 22,31,16, 03,02,02 ; PAL_SLOTS2
	RGB 31,29,31, 25,17,21, 22,31,16, 03,02,02 ; PAL_SLOTS3
	RGB 31,29,31, 16,19,29, 22,31,16, 03,02,02 ; PAL_SLOTS4
ENDC
