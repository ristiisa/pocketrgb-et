...
Enter **pocketrgb-en** where I have taken the time to compare videos of the intro's and screen shots of the games to pixel perfectly match the colors and timing of the orignial Japanese games. I also went on a massive bug hunt and solved a slew of common issues. With the cherry on top being my real pride of the project which is having replaced EVERY Pokémons names to match translations of those used in the original releases.

If you have ever wanted to reexperience the joys and wonders of Gen 1 like you never have before join us in **pocketrgb-en**. Where you will relearn the names of your favorite Pokémon. While fighting old rivals and gym leaders. Each battle gains new life as you see the many refrences and details lost in even the localizations of names!!
